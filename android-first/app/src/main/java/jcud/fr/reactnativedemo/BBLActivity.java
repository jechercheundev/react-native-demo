...
public class BBLActivity extends Activity implements DefaultHardwareBackBtnHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReactInstanceManager = ReactInstanceManager.builder()
                ...
                .build();
        mReactRootView.startReactApplication(mReactInstanceManager, "common", null);
